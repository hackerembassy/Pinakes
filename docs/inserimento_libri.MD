...
2. **Connessione Fonti Built-in** (1-2 secondi)
   - Senza plugin, interroga le due fonti built-in (Google Books, Open Library)
   - Cerca il libro nei loro cataloghi per ISBN
